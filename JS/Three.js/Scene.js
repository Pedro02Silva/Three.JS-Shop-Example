...
import { GLTFLoader } from 'three/addons/loaders/GLTFLoader.js'// importar ficheiros do blender
...
/*                          A FAZER                          */
//  adicionar modal de confirmação no reset 
...
function handleHover(event) {
    ...
    if (intersects.length > 0) {
        ...
        if(corDoObjeto != null && objetoAtual != null && objetoAtual !== object){
            //objetoAtual.material.color = corDoObjeto;
            //console.log("Aplicar", corDoObjetoSelecionado)
        }
